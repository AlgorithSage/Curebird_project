...
// Inject styles into document safely if window exists
...
const TooltipContent = forwardRef(({ className, sideOffset = 4, ...props }, ref) => (
  <TooltipPrimitive.Content
    ...
    className={cn(
      "z-50 overflow-hidden rounded-md border border-slate-700/60 bg-[#1e293b] px-3 py-1.5 text-sm text-white shadow-md animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95",
      className
    )}
    {...props}
  />
...
const DialogContent = forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-[90vw] md:max-w-[800px] translate-x-[-50%] translate-y-[-50%] gap-4 border border-slate-800 bg-[#0f172a] p-0 shadow-2xl duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out rounded-2xl",
        className
      )}
      {...props}
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 z-10 rounded-full bg-slate-800/80 p-2 hover:bg-slate-700 transition-all">
    ...
    >
      ...
      <div className="w-full h-10 flex items-center justify-center gap-0.5 px-4">
        {[...Array(visualizerBars)].map((_, i) => (
          <div
            key={i}
            className="w-0.5 rounded-full bg-amber-400/60 animate-pulse"
            style={{
      ...
      <TooltipProvider>
        ...
        >
          <div
            ref={ref}
            className={cn(
              "rounded-3xl border border-slate-800 bg-slate-950/40 p-2 shadow-2xl transition-all duration-300",
              isLoading && "border-amber-500/50 shadow-amber-500/5",
              className
            )}
...
const PromptInputTextarea = ({
  ...
  return (
    <Textarea
      ...
      className={cn("text-base text-slate-100 placeholder:text-slate-500", className)}
      disabled={disabled}
...
const CustomDivider = () => (
  <div className="relative h-6 w-[1.5px] mx-1">
    <div
      className="absolute inset-0 bg-gradient-to-t from-transparent via-amber-500/50 to-transparent rounded-full"
      style={{
...
export const PromptInputBox = forwardRef((props, ref) => {
  const { onSend = () => {}, onClear = () => {}, isLoading = false, placeholder = "Speak your heart out...", className } = props;
  ...
  return (
    <>
      <PromptInput
        ...
        className={cn(
          "w-full bg-slate-950/40 backdrop-blur-2xl border border-white/10 hover:border-amber-500/30 shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] transition-all duration-300 ease-in-out",
      ...
      >
        ...
        <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-2 border-t border-slate-800/60 mt-1">
          <div
            className={cn(
